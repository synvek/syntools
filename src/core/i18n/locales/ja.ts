...
const ja = {
  ...
  tools: {
    'video-convert': {
      formats:
        '対応形式：MP4 / MOV / WebM / MKV / AVI / MPEG-TS（非対応時は ffmpeg.wasm にフォールバック）',
      target: '出力形式',
      quality: '画質',
      qualities: {
        low: '低',
      ...
      trimStart: '開始 (s)',
      trimEnd: '終了 (s)',
      dropHint: '動画ファイルをドロップして変換',
      engines: 'エンジン：WebCodecs {{webcodecs}}、ffmpeg.wasm {{ffmpeg}}',
      available: '利用可',
      unavailable: '利用不可',
      probe: '長さ {{duration}} · {{size}} · 映像 {{video}} / 音声 {{audio}}',
      convert: '変換開始',
      converting: '変換中…',
      cancel: 'キャンセル',
      progress: '処理中 {{percent}}%',
      download: '{{name}} をダウンロード',
      usedEngine: '使用エンジン：{{engine}}',
      errors: {
        INVALID_TARGET: '未対応の出力形式です',
        INVALID_QUALITY: '画質パラメータが無効です',
        INVALID_TRIM: '切り出し範囲が無効（終了は開始より後）',
        PROBE_FAILED: 'メディア情報を読み取れません',
        WEBCodecs_VIDEO_MISSING: 'WebCodecs 映像が使えず、ffmpeg.wasm も準備できていません',
        WEBCodecs_AUDIO_MISSING: 'WebCodecs 音声が使えず、ffmpeg.wasm も準備できていません',
        NO_ENCODABLE_CODEC: '利用可能なエンコーダがありません',
        WEBCodecs_FAILED: 'WebCodecs の処理に失敗',
        UNSUPPORTED: 'この環境では ffmpeg.wasm を利用できません',
        NEED_ISOLATION: 'マルチスレッド ffmpeg.wasm には COOP/COEP による分離が必要です',
        LOAD_FAILED: 'ffmpeg.wasm コアの読み込みに失敗',
        EXEC_FAILED: 'ffmpeg の実行に失敗',
        OUTPUT_MISSING: '出力ファイルが生成されませんでした',
        CONVERT_FAILED: '変換に失敗しました',
      },
    },
    'video-to-gif': {
      formats: '対応形式：MP4 / MOV / WebM / MKV / AVI / MPEG-TS',
      usedEngine: 'フレーム抽出：{{engine}}',
      start: '開始 (s)',
      duration: '長さ (s)',
      fps: 'FPS',
      width: '幅',
      dropHint: '動画をドロップして GIF を作成',
    ...
    'audio-convert': {
      formats: '対応形式：WAV / MP3 / M4A / AAC / OGG / Opus / FLAC / WMA / AIFF',
      target: '出力形式',
      quality: '音質',
      qualities: {
        low: '低',
      ...
      mono: 'モノラル',
      stereo: 'ステレオ',
      dropHint: '音声ファイルをドロップして変換',
      processing: '処理中…',
      info: '{{rate}} Hz · {{channels}} ch · {{bitDepth}} bit · {{duration}} 秒',
      downloadWav: 'WAV をダウンロード',
      errors: {
        DECODE: '音声のデコードに失敗（非対応形式？）',
      },
    },
    'subtitle-tool': {
      target: '出力形式',
    ...
    'git-cheatsheet': {
      search: '検索',
      searchPlaceholder: 'Git コマンドまたは説明で検索',
      categories: {
        setup: '設定と初期化',
        commit: 'コミットとステージ',
        branch: 'ブランチ',
    ...
    'mime-types': {
      search: '検索',
      searchPlaceholder: '拡張子または MIME で検索',
      count: '{{count}} 件',
    },
    'http-status': {
      search: '検索',
    ...
    'id-photo': {
      ...
      sizes: {
        ...
        passport: 'パスポート ({{w}}×{{h}}mm)',
        visa: 'ビザ ({{w}}×{{h}}mm)',
        driver: '運転免許 ({{w}}×{{h}}mm)',
      },
      errors: {
        UNKNOWN_SIZE: '不明なサイズ',
        INVALID_DPI: 'DPI は 30–1200',
        LOAD: '画像の読み込みに失敗',
      },
    },
    'image-grid-cut': {
      ...
      rows: '行数',
      gap: '間隔 (px)',
      dropHint: '画像をドロップして分割',
      downloadTile: '{{row}} 行 {{col}} 列をダウンロード',
      errors: {
        EMPTY: '画像サイズが無効',
        TOO_MANY: '行/列が多すぎます（1px 未満）',
        LOAD: '画像の読み込みに失敗',
      },
    },
    'image-ascii': {
    ...
    'tax-loan-calculator': {
      ...
      effectiveRate: '実効税率',
      errors: {
        INVALID_PRINCIPAL: '借入額は 0 より大きい必要があります',
        INVALID_MONTHS: '回数は 1–1200',
        INVALID_RATE: '年利率は負にできません',
        INVALID_GROSS: '収入は負にできません',
        INVALID_DEDUCTION: '控除は負にできません',
      },
    },
    'unit-converter': {
      category: 'カテゴリ',
    ...
    'bulk-rename': {
      ...
      dropHint: 'ファイルをドロップして名前を取得',
      names: 'ファイル名（1 行に 1 つ）',
      namesPlaceholder: '1 行に 1 つ',
      output: 'リネームプレビュー',
      duplicateWarning: '⚠️ 重複名：{{names}}',
      errors: {
        EMPTY: 'ファイル名を 1 つ以上入力してください',
        INVALID_REGEX: '正規表現が無効です',
      },
    },
    'file-split-merge': {
      mode: 'モード',
      ...
      count: '分割数',
      outputName: '出力ファイル名',
      splitHint: '分割するファイルをドロップ',
      mergeHint: '結合する分割ファイルをドロップ（名前順）',
      partsCount: '{{count}} 個の分割を生成しました',
      mergedSize: '結合後 {{size}} バイト',
      mergeTip: 'すべての分割をダウンロードし、名前順で選択すると復元できます。',
      mergeOrder: '名前順に {{count}} 個を結合します',
      errors: {
        EMPTY: '内容が空です',
        INVALID_SIZE: '分割サイズは 0 より大きい必要があります',
        INVALID_COUNT: '分割数は 2 以上',
      },
    },
    'zip-manager': {
      mode: 'モード',
      ...
      archiveName: 'ファイル名',
      createHint: '複数のファイルをドロップしてまとめる',
      extractHint: '.zip をドロップして内容を確認',
      downloadZip: 'ZIP をダウンロード',
      errors: {
        NO_FILES: 'ファイルを1つ以上選択してください',
        CREATE_FAILED: '作成に失敗しました',
        INVALID_ZIP: '有効な ZIP ではありません',
    ...
    barcode: {
      ...
      height: '高さ',
      content: '内容',
      placeholder: 'バーコードの内容を入力',
      preview: 'プレビュー',
      errors: {
        EMPTY: '内容を入力してください',
        INVALID_CHARS: '未対応の文字が含まれます',
        INVALID_CHECKSUM: 'EAN-13 チェックディジットが不正',
      },
    },
    'id-generator': {
      type: '種類',
    ...
    'code-minify': {
      ...
      minify: '圧縮',
      working: '処理中…',
      conservativeHint: 'JS / HTML は安全のため保守的に圧縮（コメントと余分な空白のみ削除）。',
      input: 'ソース',
      output: '圧縮結果',
      placeholder: '圧縮するコードを貼り付け',
      saved: '{{percent}}% 削減',
      errors: {
        EMPTY: 'コードを入力してください',
        INVALID_JSON: 'JSON が不正です',
        MINIFY_FAILED: '圧縮に失敗しました',
      },
    },
    'csv-tool': {
      direction: '変換方向',
      ...
      hasHeader: '先頭行をヘッダー',
      convert: '変換',
      inputPlaceholder: 'CSV または JSON を貼り付け',
      errors: {
        EMPTY: '内容を入力してください',
        INVALID_JSON: 'JSON が不正です',
        NOT_ARRAY: 'JSON は配列である必要があります',
      },
    },
    'key-converter': {
      target: '変換先形式',
      input: 'キー入力',
      inputPlaceholder: 'PEM / DER / JWK / ssh-rsa キーを貼り付け',
      convert: '変換',
      output: '結果',
      errors: {
        EMPTY: 'キーを入力してください',
        INVALID_INPUT: 'このキーを解析できません',
        INVALID_KEY: 'キーをインポートできません',
        UNSUPPORTED: '未対応のキー種別',
        NEED_PUBLIC: 'OpenSSH は公開鍵のみ対応',
      },
    },
    'rsa-crypto': {
      mode: '操作',
      ...
      message: 'メッセージ',
      signature: '署名 (Base64)',
      signaturePlaceholder: '検証する署名を貼り付け',
      output: '出力',
      run: '実行',
      verified: '✅ 署名は有効',
      notVerified: '⚠️ 署名は無効',
      errors: {
        GENERATE_FAILED: '鍵生成に失敗',
        INVALID_KEY: '鍵形式を認識できません',
        EMPTY: '入力は空にできません',
        INVALID_INPUT: '入力形式が不正',
        ENCRYPT_FAILED: '暗号化に失敗',
        DECRYPT_FAILED: '復号に失敗（鍵または暗号文が不正）',
        SIGN_FAILED: '署名に失敗',
        VERIFY_FAILED: '検証に失敗',
      },
    },
    'password-hash': {
      ...
      errors: {
        ...
        INVALID_ITERS: '反復回数は 1–10000000',
        INVALID_SALT: 'ソルトは 8 バイト以上の 16 進数',
        DERIVE_FAILED: '派生に失敗しました',
      },
    },
    'password-strength': {
      input: 'パスワード',
      placeholder: '確認するパスワードを入力',
      toggleReveal: '表示/非表示',
      entropy: 'エントロピー約 {{bits}} bit',
      labels: {
        very_weak: '極弱',
        weak: '弱',
        fair: '普通',
      ...
      checks: {
        ...
        digit: '数字',
        symbol: '記号',
        length12: '長さ {{length}}（12 以上推奨）',
      },
      issues: {
        too_short: '短すぎます（8 文字以上）',
        no_lower: '小文字がありません',
        no_upper: '大文字がありません',
        no_digit: '数字がありません',
        no_symbol: '記号がありません',
        sequential: '連続文字（123 や abc）を含む',
        repeated: '繰り返し文字（aaa 等）を含む',
        common: 'よく使われる弱いパスワードです',
      },
    },
    checksum: {
      algorithm: 'アルゴリズム',
      source: '入力元',
      textInput: 'テキスト',
      textPlaceholder: 'チェックサムを計算するテキスト',
      fileHint: 'ファイルをドロップしてチェックサムを計算',
      result: '{{algorithm}} 結果',
      computing: '計算中…',
    },
    'encoding-rescue': {
      input: '文字化け入力',
      placeholder: '化けたテキストを貼り付け（例「ä¸­æ–‡」）',
      errors: {
        EMPTY: '入力してください',
        NO_CANDIDATE: '復元可能なエンコードなし',
      },
    },
    'escape-unescape': {
      modes: {
    ...
    'caesar-cipher': {
      ...
      rails: '段数',
      input: '入力',
      placeholder: '平文または暗号文を入力',
      output: '出力',
      errors: {
        RAILS_TOO_SMALL: '段数は 2 以上',
      },
    },
    'morse-code': {
      modes: {
      ...
      input: '入力',
      placeholder: '例：SOS または ... --- ...',
      output: '出力',
      errors: {
        INVALID: '認識できないモールス記号',
      },
    },
    'base-encoding': {
      modes: {
    ...
    'pdf-compress': {
      ...
      level: '方式',
      levels: {
        objects: 'オブジェクトストリーム（可逆）',
        raster: '各ページ JPEG（非可逆）',
      },
      quality: 'JPEG 品質',
      scale: '描画倍率',
      rasterHint: '非可逆モードはテキスト層を破棄し各ページを画像化、軽いが選択不可。',
      run: '圧縮して保存',
      result: '{{lossy}}圧縮 {{percent}}%（約 {{bytes}} バイト）',
      lossy: '非可逆',
      lossless: '可逆',
      errors: {
        NOT_PDF: 'PDF のみ対応',
        TOO_LARGE: 'ファイルが大きすぎ',
        NEED_PASSWORD: 'このファイルは暗号化されています',
        WRONG_PASSWORD: 'パスワードが違います',
        LOAD_FAILED: 'PDF を解析できません',
        NO_PAGES: 'この PDF にはページがありません',
    ...
    'pdf-watermark': {
      ...
      errors: {
        ...
        PROCESS_FAILED: '処理に失敗しました',
        EMPTY: 'ページ範囲を入力',
        INVALID_RANGE: 'ページ範囲が不正',
      },
    },
    'pdf-decrypt': {
      hint: 'パスワード付き PDF をアップロードし、開くパスワードで保護なし副本を書き出し。',
      password: '開くパスワード',
      passwordHint: 'この PDF のユーザーパスワード',
      run: 'パスワード解除して保存',
      errors: {
        NOT_PDF: 'PDF のみ対応',
        TOO_LARGE: 'ファイルが大きすぎ',
    ...
    'pdf-extract-text': {
      hint: 'PDF をアップロードすると全ページのテキストを抽出、.txt にコピーまたは保存できます。',
      password: 'パスワード（任意）',
      passwordHint: '暗号化ファイルは開くパスワードが必要',
      run: 'テキスト抽出',
      pages: '{{count}} ページ',
      errors: {
        NOT_PDF: 'PDF のみ対応',
    ...
    'random-port': {
      ...
      range: '範囲',
      unique: '重複排除',
      excludeSystem: '定番ポートを避ける',
      generate: '生成',
      ports: 'ポート',
      err: {
        INVALID_COUNT: '件数は 1–500',
        INVALID_RANGE: '範囲が不正（1–65535）',
        RANGE_TOO_SMALL: '重複排除には範囲不足',
      },
    },
    'websocket-tester': {
      url: 'サーバーURL',
      ...
      connecting: '接続中…',
      err: {
        EMPTY: 'WebSocket URL を入力',
        INVALID_URL: 'URL が不正',
        INVALID_SCHEME: 'ws/wss のみ',
      },
    },
    'http-request': {
      method: 'メソッド',
      ...
      duration: '時間',
      size: 'サイズ',
      copyCurl: 'curl としてコピー',
      err: {
        protocol: 'http(s):// で始まる URL を入力',
        EMPTY: 'curl コマンドを入力',
        NOT_CURL: '有効な curl ではない',
        NO_URL: 'curl に URL がありません',
      },
    },
    'http-headers': {
      options: 'オプション',
      ...
      opt: {
        hsts: 'HSTS を有効',
        hstsMaxAge: 'HSTS 最大年齢',
        includeSubDomains: 'サブドメインを含む',
        preload: 'プリロード',
        csp: 'CSP を有効',
        cspDirectives: 'CSP ディレクティブ',
        frameOptions: 'フレーム保護',
        contentTypeOptions: 'MIME スニッフィング防止',
        permissionsPolicy: '権限ポリシー',
        referrerPolicy: 'リファラポリシー',
        coop: 'COOP',
        coep: 'COEP',
        corsOrigin: 'CORS オリジン',
      },
    },
    'ua-generator': {
      generate: '再生成',
    ...
    'mac-address': {
      ...
      err: {
        EMPTY: 'MAC を入力',
        INVALID: 'MAC 形式が不正',
        INVALID_COUNT: '件数は 1–200',
      },
    },
    'ip-calc': {
      input: '入力',
      placeholder: '192.168.1.100/24 または 2001:db8::1/64',
      fields: {
        network: 'ネットワーク',
        lastAddress: '最後のアドレス',
        firstHost: '最初のホスト',
      ...
      splitTitle: 'サブネット分割（VLSM / 等長）',
      splitPlaceholder: 'ターゲット接頭辞、例 26',
      err: {
        EMPTY: 'IP を入力してください',
        INVALID_PREFIX: '接頭辞が不正',
        INVALID_ADDRESS: 'アドレスが不正',
        INVALID_SPLIT_PREFIX: 'ターゲット接頭辞は元より大きく',
        TOO_MANY_SUBNETS: 'サブネット数が上限 {{max}} を超過',
      },
    },
    base64: {
      direction: {
    ...
    regex: {
      ...
      err: {
        ...
        TEXT_TOO_LONG:
          'テキストが {{limit}}K 文字制限を超過。マッチングを停止（ReDoS / 長時間実行保護）',
      },
    },
    textDiff: {
      oldText: '原文',
    ...
    json: {
      ...
      err: {
        ...
        INVALID_LITERAL:
          'JSON 解析失敗：リテラル "{{literal}}" が必要（{{line}} 行、{{column}} 列）',
        NEWLINE_IN_STRING: 'JSON 解析失敗：文字列は改行できません（{{line}} 行、{{column}} 列）',
        UNEXPECTED_STRING_END: 'JSON 解析失敗：文字列が予期せず終了（{{line}} 行、{{column}} 列）',
        INVALID_UNICODE_ESCAPE:
          'JSON 解析失敗：無効な \\u エスケープ、16 進 4 桁が必要（{{line}} 行、{{column}} 列）',
        INVALID_ESCAPE:
          'JSON 解析失敗：無効なエスケープ "\\{{char}}"（{{line}} 行、{{column}} 列）',
        ...
        UNEXPECTED_END:
          'JSON 解析失敗：予期しない終端、値がありません（{{line}} 行、{{column}} 列）',
        INVALID_CHAR: 'JSON 解析失敗：無効な文字 "{{char}}"（{{line}} 行、{{column}} 列）',
        TRAILING_COMMA: 'JSON 解析失敗：末尾のカンマは不可（{{line}} 行、{{column}} 列）',
        KEY_MUST_BE_STRING:
          'JSON 解析失敗：オブジェクトのキーは文字列である必要があります（{{line}} 行、{{column}} 列）',
        MISSING_COLON:
          'JSON 解析失敗：オブジェクトキーの後に ":" がありません（{{line}} 行、{{column}} 列）',
        MISSING_VALUE: 'JSON 解析失敗：値がありません（{{line}} 行、{{column}} 列）',
        UNCLOSED_OBJECT:
          'JSON 解析失敗：オブジェクトが閉じていません、"}" がありません（{{line}} 行、{{column}} 列）',
        MISSING_COMMA_OBJECT:
          'JSON 解析失敗：オブジェクト要素の間に "," がありません（{{line}} 行、{{column}} 列）',
        UNCLOSED_ARRAY:
          'JSON 解析失敗：配列が閉じていません、"]" がありません（{{line}} 行、{{column}} 列）',
        MISSING_COMMA_ARRAY:
          'JSON 解析失敗：配列要素の間に "," がありません（{{line}} 行、{{column}} 列）',
    ...
    hash: {
      ...
      computing: '計算中…',
      fileHint:
        'ファイルをここにドラッグ＆ドロップ、またはクリックして選択（MD5 はストリーム。大容量もメモリ安全）',
      limitHint:
        '注：MD5 以外はファイル全体をメモリに読み込みます。非常に大きいファイルはメモリ不足になる場合があります',
      err: {
    ...
    cron: {
      ...
      err: {
        ...
        INVALID:
          '解析できません：フィールド数（5 または 6）と範囲（分 0-59 / 時 0-23 / 日 1-31 / 月 1-12 / 曜日 0-7）を確認',
      },
      desc: {
        every: {
          second: '毎秒',
    ...
    image: {
      ...
      original: '元のサイズ',
      dropHint:
        '画像をここにドラッグ＆ドロップ、またはクリックして選択（PNG / JPEG / WebP / GIF など）',
      before: '原文',
      after: '出力',
      saved: 'サイズが {{ratio}}% 削減',
    ...
    doodle: {
      ...
      fgColor: '前景色（線）',
      bgColor: '背景色（塗りつぶし）',
      swapColors: '前景/背景色を入れ替え',
      moreColors: 'その他の色',
      recentColors: '最近使用した色',
      colorHint: '左クリックで前景色（線）、右クリックで背景色（塗りつぶし）',
      zoom: 'ズーム',
      zoomIn: '拡大',
      zoomOut: '縮小',
      zoomFit: 'ウィンドウに合わせる',
      polygonHint:
        'クリックで頂点を追加。始点をクリックまたは Enter で閉じる。Backspace で1点削除、Esc でキャンセル',
      moveHint: 'ドラッグで全体を移動',
      pickerHint: 'キャンバスをクリックして色を取得',
      size: 'サイズ',
      opacity: '不透明度',
      pressure: '筆圧',
      fill: '塗りつぶし',
      ...
      customColor: 'カスタムカラー',
      background: 'キャンバス地',
      bg: { transparent: '透明', solid: '単色', grid: 'グリッド' },
      canvasSize: 'キャンバス',
      sizeFit: '自動調整',
      sizeCustom: 'カスタム',
      width: '幅',
      ...
      undo: '元に戻す',
      redo: 'やり直す',
      hint: 'キャンバスをドラッグして描画。マウス・タッチ・ペン筆圧に対応。スウォッチを右クリックで背景色に設定',
      hintKeys:
        'Ctrl/⌘+Z 元に戻す、Ctrl/⌘+Shift+Z やり直し、1~9 でツール切替、I スポイト / V 移動、Enter で多角形を閉じる',
