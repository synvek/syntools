...
const es = {
  ...
  tools: {
    'video-convert': {
      formats:
        'Formatos admitidos: MP4 / MOV / WebM / MKV / AVI / MPEG-TS (si no, usa ffmpeg.wasm)',
      ...
      trimStart: 'Inicio (s)',
      trimEnd: 'Fin (s)',
      dropHint: 'Suelta un vídeo para transcodificar',
      engines: 'Motores: WebCodecs {{webcodecs}}, ffmpeg.wasm {{ffmpeg}}',
      available: 'disponible',
      unavailable: 'no disponible',
      probe: '{{duration}} · {{size}} · vídeo {{video}} / audio {{audio}}',
      convert: 'Convertir',
      converting: 'Convirtiendo…',
      cancel: 'Cancelar',
      progress: 'Procesando {{percent}}%',
      download: 'Descargar {{name}}',
      usedEngine: 'Motor: {{engine}}',
      errors: {
        INVALID_TARGET: 'Formato destino no admitido',
        INVALID_QUALITY: 'Calidad no válida',
        INVALID_TRIM: 'Rango de recorte no válido (fin después de inicio)',
        PROBE_FAILED: 'No se puede leer la información',
        WEBCodecs_VIDEO_MISSING: 'WebCodecs de vídeo no disponible y ffmpeg.wasm no está listo',
        WEBCodecs_AUDIO_MISSING: 'WebCodecs de audio no disponible y ffmpeg.wasm no está listo',
        NO_ENCODABLE_CODEC: 'No hay codificador utilizable',
        WEBCodecs_FAILED: 'Fallo al procesar con WebCodecs',
        UNSUPPORTED: 'ffmpeg.wasm no es compatible aquí',
        NEED_ISOLATION:
          'Se requiere aislamiento cross-origin (COOP/COEP) para ffmpeg.wasm multihilo',
        LOAD_FAILED: 'No se pudo cargar el núcleo de ffmpeg.wasm',
        EXEC_FAILED: 'Fallo al ejecutar ffmpeg',
        OUTPUT_MISSING: 'No se generó ningún archivo',
        CONVERT_FAILED: 'Conversión fallida',
      },
    },
    'video-to-gif': {
      formats: 'Formatos admitidos: MP4 / MOV / WebM / MKV / AVI / MPEG-TS',
      usedEngine: 'Motor de fotogramas: {{engine}}',
      start: 'Inicio (s)',
      duration: 'Duración (s)',
      fps: 'FPS',
      width: 'Ancho',
      dropHint: 'Suelta un vídeo para crear un GIF',
      processing: 'Generando {{percent}}%',
      preview: 'Vista previa',
      downloadGif: 'Descargar GIF',
      errors: {
        EMPTY: 'No hay fotogramas',
        INVALID_FPS: 'FPS no válidos',
        PROCESS: 'Fallo al procesar el vídeo',
      },
    },
    'audio-convert': {
      formats: 'Formatos admitidos: WAV / MP3 / M4A / AAC / OGG / Opus / FLAC / WMA / AIFF',
      target: 'Formato destino',
      quality: 'Calidad',
      qualities: {
        low: 'Baja',
      ...
      mono: 'Mono',
      stereo: 'Estéreo',
      dropHint: 'Suelta un archivo de audio para convertir',
      processing: 'Procesando…',
      info: '{{rate}} Hz · {{channels}} canales · {{bitDepth}} bits · {{duration}} s',
      downloadWav: 'Descargar WAV',
      errors: {
        DECODE: 'Fallo al decodificar el audio (¿formato no admitido?)',
      },
    },
    'subtitle-tool': {
      target: 'Formato destino',
      offset: 'Desplazamiento (ms)',
      cueCount: '{{count}} subtítulos',
      input: 'Subtítulos',
      output: 'Resultado',
      errors: {
        EMPTY: 'Introduce subtítulos',
        INVALID: 'No se puede analizar',
      },
    },
    'git-cheatsheet': {
      search: 'Buscar',
      searchPlaceholder: 'Busca un comando Git o descripción',
      categories: {
        setup: 'Configuración',
        commit: 'Commit y staging',
        branch: 'Ramas',
        remote: 'Remoto',
        undo: 'Deshacer y reset',
        log: 'Inspección y log',
        stash: 'Stash',
        tag: 'Etiquetas',
      },
    },
    ...
    'http-status': {
      search: 'Buscar',
      searchPlaceholder: 'Buscar código, nombre o descripción',
      count: '{{count}} resultados',
    },
    'id-photo': {
      size: 'Tamaño',
      ...
      background: 'Fondo',
      format: 'Formato',
      dropHint: 'Suelta una foto para procesar',
      preview: 'Vista previa',
      sizes: {
        'one-inch': '1 pulgada ({{w}}×{{h}}mm)',
        'small-one': 'Pequeña 1 pulgada ({{w}}×{{h}}mm)',
        'large-one': 'Grande 1 pulgada ({{w}}×{{h}}mm)',
        'two-inch': '2 pulgadas ({{w}}×{{h}}mm)',
        'small-two': 'Pequeña 2 pulgadas ({{w}}×{{h}}mm)',
        passport: 'Pasaporte ({{w}}×{{h}}mm)',
        visa: 'Visado ({{w}}×{{h}}mm)',
        driver: 'Carné ({{w}}×{{h}}mm)',
      },
      errors: {
        UNKNOWN_SIZE: 'Tamaño desconocido',
        INVALID_DPI: 'DPI entre 30 y 1200',
        LOAD: 'Error al cargar la imagen',
      },
    },
    'image-grid-cut': {
      cols: 'Columnas',
      rows: 'Filas',
      gap: 'Separación (px)',
      dropHint: 'Suelta una imagen para cortar',
      downloadTile: 'Descargar fila {{row}}, columna {{col}}',
      errors: {
        EMPTY: 'Tamaño de imagen no válido',
        TOO_MANY: 'Demasiadas filas/columnas (< 1px)',
        LOAD: 'Error al cargar la imagen',
      },
    },
    'image-ascii': {
      ...
      invert: 'Invertir',
      dropHint: 'Suelta una imagen para convertir',
      output: 'Arte ASCII',
      errors: {
        EMPTY: 'Tamaño de imagen no válido',
        INVALID: 'Píxeles no válidos',
        LOAD: 'Error al cargar la imagen',
      },
    },
    'timezone-converter': {
      datetime: 'Fecha y hora',
      sourceZone: 'Zona de origen',
      errors: {
    ...
    'tax-loan-calculator': {
      ...
      loanMode: 'Amortización',
      equalPayment: 'Cuota constante',
      equalPrincipal: 'Capital constante',
      principal: 'Importe',
      rate: 'Tasa anual (%)',
      months: 'Meses',
      firstPayment: 'Primera cuota',
      ...
      errors: {
        INVALID_PRINCIPAL: 'El importe debe ser > 0',
        INVALID_MONTHS: 'Los meses deben ser 1–1200',
        INVALID_RATE: 'La tasa no puede ser negativa',
        INVALID_GROSS: 'El ingreso no puede ser negativo',
        INVALID_DEDUCTION: 'Las deducciones no pueden ser negativas',
      },
    },
    'unit-converter': {
      category: 'Categoría',
      ...
      errors: {
        ...
        INVALID: 'Valor o unidad no válidos',
      },
    },
    'bulk-rename': {
      prefix: 'Prefijo',
      ...
      dropHint: 'Suelta archivos para llenar la lista',
      names: 'Nombres (uno por línea)',
      namesPlaceholder: 'Un nombre por línea',
      output: 'Vista previa',
      duplicateWarning: '⚠️ Nombres duplicados: {{names}}',
      errors: {
        EMPTY: 'Introduce al menos un nombre',
    ...
    'file-split-merge': {
      ...
      splitHint: 'Suelta el archivo a dividir',
      mergeHint: 'Suelta las partes a unir (ordenadas por nombre)',
      partsCount: '{{count}} partes generadas',
      mergedSize: 'Tamaño unido {{size}} bytes',
      mergeTip: 'Descarga todas las partes; la unión las ordena por nombre.',
      mergeOrder: 'Uniendo {{count}} partes por orden de nombre',
      errors: {
        EMPTY: 'El contenido está vacío',
        INVALID_SIZE: 'El tamaño debe ser > 0',
        INVALID_COUNT: 'Las partes deben ser ≥ 2',
      },
    },
    'zip-manager': {
      mode: 'Modo',
      ...
      createHint: 'Suelta varios archivos para empaquetar',
      extractHint: 'Suelta un .zip para inspeccionar',
      downloadZip: 'Descargar ZIP',
      errors: {
        NO_FILES: 'Selecciona al menos un archivo',
    ...
    barcode: {
      ...
      preview: 'Vista previa',
      errors: {
        EMPTY: 'Introduce contenido',
        INVALID_CHARS: 'Contiene caracteres no admitidos',
        INVALID_CHECKSUM: 'Dígito de control EAN-13 no válido',
      },
    },
    'id-generator': {
      type: 'Tipo',
      ...
      output: 'Resultado',
      errors: {
        INVALID_COUNT: 'La cantidad debe ser 1–1000',
      },
    },
    'code-minify': {
      language: 'Lenguaje',
      minify: 'Minificar',
      working: 'Procesando…',
      conservativeHint: 'JS / HTML usan minificación conservadora (solo comentarios y espacios).',
      input: 'Código',
      output: 'Resultado',
      placeholder: 'Pega el código a minificar',
      saved: '{{percent}}% menos',
      errors: {
        EMPTY: 'Introduce código',
        INVALID_JSON: 'JSON no válido',
        MINIFY_FAILED: 'Minificación fallida',
      },
    },
    'csv-tool': {
      direction: 'Dirección',
      delimiter: 'Delimitador',
      hasHeader: 'Primera fila = cabecera',
      convert: 'Convertir',
      inputPlaceholder: 'Pega CSV o JSON',
      errors: {
        EMPTY: 'Introduce contenido',
        INVALID_JSON: 'JSON no válido',
        NOT_ARRAY: 'El JSON debe ser un array',
      },
    },
    'key-converter': {
      target: 'Formato destino',
      input: 'Clave',
      inputPlaceholder: 'Pega una clave PEM / DER / JWK / ssh-rsa',
      convert: 'Convertir',
      output: 'Resultado',
      errors: {
        EMPTY: 'Introduce una clave',
        INVALID_INPUT: 'Clave ilegible',
        INVALID_KEY: 'Clave no importable',
        UNSUPPORTED: 'Tipo de clave no admitido',
        NEED_PUBLIC: 'OpenSSH solo admite claves públicas',
      },
    },
    'rsa-crypto': {
      mode: 'Acción',
      bits: 'Tamaño de clave',
      generate: 'Generar par',
      modes: {
        generate: 'Generar',
        encrypt: 'Cifrar',
        decrypt: 'Descifrar',
      ...
      signaturePlaceholder: 'Pega la firma a verificar',
      output: 'Salida',
      run: 'Ejecutar',
      verified: '✅ Firma válida',
      notVerified: '⚠️ Firma inválida',
      errors: {
        GENERATE_FAILED: 'Fallo al generar claves',
        INVALID_KEY: 'Formato de clave no reconocido',
        EMPTY: 'La entrada no puede estar vacía',
        INVALID_INPUT: 'Formato de entrada inválido',
        ENCRYPT_FAILED: 'Cifrado fallido',
        DECRYPT_FAILED: 'Descifrado fallido (clave o texto erróneos)',
    ...
    'password-hash': {
      ...
      salt: 'Sal (Hex)',
      saltPlaceholder: 'Vacío = 16 bytes aleatorios',
      ...
      errors: {
        ...
        INVALID_ITERS: 'Iteraciones entre 1 y 10000000',
        INVALID_SALT: 'La sal debe ser hex de ≥ 8 bytes',
        DERIVE_FAILED: 'Fallo la derivación',
      },
    },
    'password-strength': {
      input: 'Contraseña',
      ...
      checks: {
        ...
        digit: 'Dígitos',
        symbol: 'Símbolos',
        length12: 'Longitud {{length}} (≥ 12 recomendado)',
      },
      issues: {
        too_short: 'Demasiado corta, al menos 8 caracteres',
        no_lower: 'Faltan minúsculas',
        no_upper: 'Faltan mayúsculas',
        no_digit: 'Faltan dígitos',
        no_symbol: 'Faltan símbolos',
        sequential: 'Contiene secuencias como 123 o abc',
        repeated: 'Contiene repeticiones como aaa',
        common: 'Coincide con una contraseña débil común',
      },
    },
    checksum: {
      algorithm: 'Algoritmo',
      source: 'Origen',
      textInput: 'Texto',
      textPlaceholder: 'Texto a comprobar',
      fileHint: 'Suelta un archivo para calcular su suma',
      result: '{{algorithm}} resultado',
      computing: 'Calculando…',
    },
    'encoding-rescue': {
      input: 'Texto corrupto',
      placeholder: "Pega el texto roto, p. ej. 'ä¸­æ–‡'",
      errors: {
        EMPTY: 'Introduce algo',
        NO_CANDIDATE: 'No se encontró codificación',
      },
    },
    'escape-unescape': {
      modes: {
    ...
    'caesar-cipher': {
      ...
      rails: 'Filas',
      input: 'Entrada',
      placeholder: 'Texto o cifrado',
      output: 'Salida',
      errors: {
        RAILS_TOO_SMALL: 'Filas ≥ 2',
      },
    },
    'morse-code': {
      modes: {
      ...
      input: 'Entrada',
      placeholder: 'p. ej. SOS o ... --- ...',
      output: 'Salida',
      errors: {
        INVALID: 'Símbolo Morse no reconocido',
      },
    },
    'base-encoding': {
      modes: {
      ...
      errors: {
        EMPTY: 'Introduce algo',
        INVALID: 'Codificación no válida',
      },
    },
    'pdf-compress': {
      ...
      level: 'Método',
      levels: {
        objects: 'Flujos de objetos (sin pérdida)',
        raster: 'JPEG por página (con pérdida)',
      },
      quality: 'Calidad JPEG',
      scale: 'Escala de render',
      rasterHint:
        'El modo con pérdida elimina el texto y redibuja cada página como imagen: más ligero pero no seleccionable.',
      run: 'Comprimir',
      result: '{{lossy}} comprimido un {{percent}}% (~{{bytes}} bytes)',
      lossy: 'Con pérdida',
      lossless: 'Sin pérdida',
      errors: {
        NOT_PDF: 'Solo se admiten PDF',
        TOO_LARGE: 'Archivo demasiado grande',
        NEED_PASSWORD: 'Archivo cifrado, introduce la contraseña',
        WRONG_PASSWORD: 'Contraseña incorrecta',
        LOAD_FAILED: 'No se pudo analizar el PDF',
        NO_PAGES: 'El PDF no tiene páginas',
        PROCESS_FAILED: 'Error de procesamiento',
      },
    },
    'pdf-watermark': {
      password: 'Contraseña (opcional)',
      ...
      pageSelection: 'Rango (ej. 1-3,5)',
      tiled: 'Mosaico',
      spacing: 'Espaciado',
      run: 'Añadir marca de agua',
      errors: {
        NOT_PDF: 'Solo se admiten PDF',
        TOO_LARGE: 'Archivo demasiado grande',
        EMPTY_TEXT: 'Introduce el texto',
        ...
        NO_PAGES: 'El PDF no tiene páginas',
        PROCESS_FAILED: 'Error de procesamiento',
        EMPTY: 'Introduce un rango',
        INVALID_RANGE: 'Rango no válido',
      },
    },
    'pdf-decrypt': {
      hint: 'Sube un PDF protegido, introduce la contraseña y exporta una copia sin protección.',
      password: 'Contraseña de apertura',
      passwordHint: 'La contraseña de usuario del PDF',
      run: 'Quitar contraseña',
      errors: {
        NOT_PDF: 'Solo se admiten PDF',
        TOO_LARGE: 'Archivo demasiado grande',
        NEED_PASSWORD: 'Archivo cifrado, introduce la contraseña',
    ...
    'pdf-extract-text': {
      hint: 'Sube un PDF para extraer el texto de todas las páginas, copia o descarga como .txt.',
      password: 'Contraseña (opcional)',
      passwordHint: 'Los cifrados necesitan la contraseña',
      run: 'Extraer texto',
      pages: '{{count}} páginas',
      errors: {
        NOT_PDF: 'Solo se admiten PDF',
    ...
    'random-port': {
      ...
      range: 'Rango',
      unique: 'Único',
      excludeSystem: 'Evitar puertos comunes',
      generate: 'Generar',
      ports: 'Puertos',
      err: {
        INVALID_COUNT: 'Cantidad 1–500',
        INVALID_RANGE: 'Rango no válido (1–65535)',
        RANGE_TOO_SMALL: 'Rango demasiado pequeño',
      },
    },
    'websocket-tester': {
      ...
      err: {
        EMPTY: 'Introduce URL WebSocket',
        INVALID_URL: 'URL no válida',
        INVALID_SCHEME: 'Solo ws/wss permitidos',
      },
    },
    'http-request': {
      method: 'Método',
      ...
      err: {
        protocol: 'Introduce URL que empiece por http(s)://',
        EMPTY: 'Introduce un comando curl',
        NOT_CURL: 'No es un comando curl válido',
        NO_URL: 'Falta URL en curl',
      },
    },
    'http-headers': {
      options: 'Opciones',
      ...
      opt: {
        ...
        frameOptions: 'Opción frame',
        contentTypeOptions: 'Sin sniffing',
        permissionsPolicy: 'Permissions policy',
        referrerPolicy: 'Política de referencia',
        coop: 'COOP',
        coep: 'COEP',
        corsOrigin: 'Origen CORS',
      },
    },
    'ua-generator': {
      generate: 'Regenerar',
      copyAll: 'Descargar todo',
    },
    'url-parser': {
      input: 'Introduce URL',
    ...
    'mac-address': {
      ...
      oui: 'Prefijo OUI',
      eui64: 'EUI-64',
      linkLocal: 'Dirección link-local',
      generateTitle: 'Generar en masa',
      count: 'Cantidad',
      separator: 'Separador',
      caseLabel: 'Mayúsculas',
      generate: 'Generar',
      err: {
        EMPTY: 'Introduce una MAC',
        INVALID: 'Formato MAC no válido',
        INVALID_COUNT: 'Cantidad 1–200',
      },
    },
    'ip-calc': {
      input: 'Entrada',
      ...
      splitTitle: 'División de subred (VLSM / igual)',
      splitPlaceholder: 'Prefijo objetivo, ej. 26',
      err: {
        EMPTY: 'Introduce una IP',
        INVALID_PREFIX: 'Prefijo no válido',
        INVALID_ADDRESS: 'Dirección no válida',
        INVALID_SPLIT_PREFIX: 'El prefijo objetivo debe ser mayor',
        TOO_MANY_SUBNETS: 'Demasiadas subredes (máx. {{max}})',
      },
    },
    base64: {
      direction: {
    ...
    url: {
      ...
      err: {
        ENCODE_FAILED:
          'Error al codificar: la entrada contiene caracteres sustitutos no emparejados',
    ...
    regex: {
      ...
      err: {
        ...
        TEXT_TOO_LONG:
          'El texto supera el límite de {{limit}}K caracteres; se detuvo la coincidencia (protección ReDoS / ejecución larga)',
      },
    },
    textDiff: {
      oldText: 'Originale',
      ...
      err: {
        TOO_LARGE:
          'El texto combinado supera el límite de {{limit}}K caracteres; se detuvo el diff (protección de ejecución larga)',
      },
    },
    json: {
      actions: {
      ...
      err: {
        ...
        INVALID_LITERAL:
          'JSON análisis incorrecto: letterale previsto " {{literal}} " (línea {{line}} , columna {{column}} )',
        NEWLINE_IN_STRING:
          'Error al analizar JSON: la cadena no puede abarcar líneas (línea {{line}}, columna {{column}})',
        UNEXPECTED_STRING_END:
          'JSON análisis incorrecto: cadena terminata inaspettatamente (línea {{line}} , columna {{column}} )',
        INVALID_UNICODE_ESCAPE:
          'JSON análisis incorrecto: escape no válido \\u, son necessarie 4 cifre esadecimali (línea {{line}} , columna {{column}} )',
        INVALID_ESCAPE:
          'JSON análisis incorrecto: escape no válido "\\ {{char}} " (línea {{line}} , columna {{column}} )',
        INVALID_NUMBER:
          'JSON análisis incorrecto: número no válido (línea {{line}} , columna {{column}} )',
        DECIMAL_NO_DIGITS:
          'JSON análisis incorrecto: cifre richieste después la virgola decimale (línea {{line}} , columna {{column}} )',
        EXPONENT_NO_DIGITS:
          "JSON análisis incorrecto: cifre richieste nell'esponente (línea {{line}} , columna {{column}} )",
        UNEXPECTED_END:
          'JSON análisis incorrecto: fine imprevista, valor mancante (línea {{line}} , columna {{column}} )',
        INVALID_CHAR:
          'JSON análisis incorrecto: carácter " {{char}} " no válido (línea {{line}} , columna {{column}} )',
        TRAILING_COMMA:
          'JSON análisis incorrecto: virgola finale no consentita (línea {{line}} , columna {{column}} )',
        KEY_MUST_BE_STRING:
          "JSON análisis incorrecto: la clave dell'oggetto debe essere una cadena (línea {{line}} , columna {{column}} )",
        MISSING_COLON:
          'JSON análisis incorrecto: manca ":" después la clave dell\'oggetto (línea {{line}} , columna {{column}} )',
        MISSING_VALUE:
          'JSON análisis incorrecto: valor mancante (línea {{line}} , columna {{column}} )',
        UNCLOSED_OBJECT:
          'JSON análisis incorrecto: oggetto no chiuso, "}" mancante (línea {{line}} , columna {{column}} )',
        MISSING_COMMA_OBJECT:
          'JSON análisis incorrecto: manca "," entre los membri dell\'oggetto (línea {{line}} , columna {{column}} )',
        UNCLOSED_ARRAY:
          'JSON análisis incorrecto: matrice no chiusa, manca "]" (línea {{line}} , columna {{column}} )',
        MISSING_COMMA_ARRAY:
          'JSON análisis incorrecto: manca "," entre los elementi dell\'array (línea {{line}} , columna {{column}} )',
        EXTRA_CONTENT:
          'JSON análisis incorrecto: contenido extra después el valor (línea {{line}} , columna {{column}} )',
        UNCLOSED_STRING:
          'JSON análisis incorrecto: cadena no chiusa (línea {{line}} , columna {{column}} )',
      },
    },
    timestamp: {
    ...
    hash: {
      ...
      computing: 'Calculando…',
      fileHint:
        'Arrastra y suelta un archivo aquí, o haz clic para elegir (MD5 en streaming; archivos grandes seguros en memoria)',
      limitHint:
        'Nota: los algoritmos distintos de MD5 cargan el archivo completo en memoria; archivos muy grandes pueden agotar la memoria',
      err: {
    ...
    'aes-crypto': {
      ...
      err: {
        ...
        INVALID_KEY:
          'Clave no válida: controlla la passphrase o la lunghezza de la clave esadecimale',
    ...
    cron: {
      ...
      err: {
        ...
        INVALID:
          'No se puede analizar: comprueba el nº de campos (5 o 6) y los rangos (min 0-59 / hora 0-23 / día 1-31 / mes 1-12 / día sem. 0-7)',
      },
      desc: {
        every: {
          second: 'cada attimo,',
    ...
    convert: {
      ...
      err: {
        ...
        STRINGIFY:
          'No se puede convertir al formato de destino (p. ej. TOML no admite arrays/escalares de nivel superior)',
      },
    },
    sql: {
      dialect: 'Dialecto',
    ...
    qr: {
      ...
      err: {
        ...
        TOO_LONG:
          'El contenido es demasiado largo para un código QR: acórtalo o baja el nivel de corrección de errores',
    ...
    radix: {
      ...
      operandB: 'Operando B',
      opHint:
        "L'operando A riutilizza el input de cui arriba; los risultati rimangono all'interno dell'intervallo de números interi con segno a 64 bit",
      ops: {
        and: 'AND',
        or: 'OR',
        xor: 'XOR',
    ...
    image: {
      ...
      dropHint:
        'Arrastra y suelta una imagen aquí, o haz clic para elegir (PNG / JPEG / WebP / GIF, etc.)',
      before: 'Originale',
      after: 'Saída',
      ...
      err: {
        ...
        ENCODE:
          "Codificación imagen no correcta: asegúrate che el browser supporti este formato o prova un'otra imagen",
      },
    },
    jsonConvert: {
    ...
    calendar: {
      ...
      ji: 'Evitar',
      legendZh:
        "Il rosso segna los fine settimana o las feste; 休 = riposo legale, 班 = día lavorativo de trucco. Punte dell'almanacco a destra.",
      legendEn:
        "I días rossi son fine settimana o festivi. L'inglese utilizza los días festivi statunitensi (en-GB utilizza los días festivi del Regno Unito).",
      rest: {
        off: 'Festivo',
        work: 'Workday',
    ...
    doodle: {
      ...
      export: 'Exportar',
      fgColor: 'Primer plano (trazo)',
      bgColor: 'Fondo (relleno)',
      swapColors: 'Intercambiar colores',
      moreColors: 'Más colores',
      recentColors: 'Recientes',
      colorHint: 'Clic izquierdo: primer plano (trazo); clic derecho: fondo (relleno)',
      zoom: 'Zoom',
      zoomIn: 'Acercar',
      zoomOut: 'Alejar',
      zoomFit: 'Ajustar',
      polygonHint:
        'Haz clic para añadir puntos; haz clic en el primer punto o pulsa Intro para cerrar; Retroceso elimina el último punto; Esc cancela',
      moveHint: 'Arrastra para mover todo el dibujo',
      pickerHint: 'Haz clic en el lienzo para tomar un color',
      size: 'Tamaño',
      opacity: 'Opacidad',
      pressure: 'Presión',
      fill: 'Relleno',
      ...
      background: 'Base del lienzo',
      bg: { transparent: 'Transparente', solid: 'Sólido', grid: 'Cuadrícula' },
      canvasSize: 'Lienzo',
      sizeFit: 'Ajustar',
      ...
      undo: 'Deshacer',
      redo: 'Rehacer',
      hint: 'Arrastra sobre el lienzo para dibujar; se admiten ratón, táctil y presión del lápiz; clic derecho en una muestra para definir el fondo',
      hintKeys:
        'Ctrl/⌘+Z deshacer, Ctrl/⌘+Shift+Z rehacer, 1~9 cambiar herramienta, I cuentagotas / V mover, Intro cierra el polígono',
    ...
    mbti: {
      ...
      disclaimer:
        'Questo es un quiz semplificato solo para intrattenimento, no una valutación clinica.',
      dims: {
