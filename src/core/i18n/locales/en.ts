...
const en = {
  ...
  toolsMeta: {
    ...
    'pdf-annotate': { name: 'Annotate PDF', description: 'Highlight, line, or rectangle annotations' },
  },
  tools: {
    base64: {
      direction: {
    ...
    'pdf-annotate': {
      hint: 'Add highlight/line/rect annotations. Origin is bottom-left.',
      page: 'Page',
      width: 'Width',
      height: 'Height',
      color: 'Color',
      add: 'Add annotation',
      run: 'Apply & download',
      kinds: { highlight: 'Highlight', line: 'Line', rect: 'Rectangle' },
      errors: {
        EMPTY: 'Please complete the input',
        NOT_PDF: 'Please upload a PDF file',
        NOT_IMAGE: 'Please upload an image file',
