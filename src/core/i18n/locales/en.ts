...
const en = {
  ...
  tools: {
    'video-convert': {
      formats:
        'Supported: MP4 / MOV / WebM / MKV / AVI / MPEG-TS (falls back to ffmpeg.wasm when needed)',
      ...
      trimStart: 'Start (s)',
      trimEnd: 'End (s)',
      dropHint: 'Drop a video file to transcode',
      ...
      errors: {
        INVALID_TARGET: 'Unsupported target format',
        INVALID_QUALITY: 'Invalid quality',
        INVALID_TRIM: 'Invalid trim range (end must be after start)',
        PROBE_FAILED: 'Cannot read media info',
        WEBCodecs_VIDEO_MISSING: 'WebCodecs video is unavailable and ffmpeg.wasm is not ready',
        WEBCodecs_AUDIO_MISSING: 'WebCodecs audio is unavailable and ffmpeg.wasm is not ready',
        NO_ENCODABLE_CODEC: 'No usable encoder found',
        WEBCodecs_FAILED: 'WebCodecs processing failed',
        UNSUPPORTED: 'ffmpeg.wasm is not supported here',
        NEED_ISOLATION:
          'Cross-origin isolation (COOP/COEP) is required for multi-threaded ffmpeg.wasm',
        LOAD_FAILED: 'Failed to load ffmpeg.wasm core',
        EXEC_FAILED: 'ffmpeg execution failed',
        OUTPUT_MISSING: 'No output file produced',
        CONVERT_FAILED: 'Conversion failed',
      },
    },
    'video-to-gif': {
      formats: 'Supported: MP4 / MOV / WebM / MKV / AVI / MPEG-TS',
      usedEngine: 'Frame engine: {{engine}}',
      start: 'Start (s)',
      duration: 'Duration (s)',
      fps: 'FPS',
      width: 'Width',
      dropHint: 'Drop a video file to make a GIF',
      ...
      errors: {
        ...
        PROCESS: 'Video processing failed',
      },
    },
    'audio-convert': {
      formats: 'Supported: WAV / MP3 / M4A / AAC / OGG / Opus / FLAC / WMA / AIFF',
      target: 'Target format',
      quality: 'Quality',
      qualities: {
        low: 'Low',
      ...
      mono: 'Mono',
      stereo: 'Stereo',
      dropHint: 'Drop an audio file to convert',
      processing: 'Processing…',
      info: '{{rate}} Hz · {{channels}} ch · {{bitDepth}} bit · {{duration}}s',
      downloadWav: 'Download WAV',
      errors: {
        DECODE: 'Audio decoding failed (unsupported format?)',
      },
    },
    'subtitle-tool': {
      target: 'Target format',
      ...
      output: 'Result',
      errors: {
        EMPTY: 'Please enter subtitles',
        INVALID: 'Cannot parse subtitles',
      },
    },
    'git-cheatsheet': {
      search: 'Search',
      searchPlaceholder: 'Search a Git command or description',
      categories: {
        setup: 'Setup',
    ...
    'mime-types': {
      search: 'Search',
      searchPlaceholder: 'Search extension or MIME type',
      count: '{{count}} results',
    },
    'http-status': {
      search: 'Search',
    ...
    'id-photo': {
      ...
      format: 'Format',
      dropHint: 'Drop a photo to process',
      preview: 'Preview',
      sizes: {
        'one-inch': '1 inch ({{w}}×{{h}}mm)',
        'small-one': 'Small 1 inch ({{w}}×{{h}}mm)',
        'large-one': 'Large 1 inch ({{w}}×{{h}}mm)',
        'two-inch': '2 inch ({{w}}×{{h}}mm)',
        'small-two': 'Small 2 inch ({{w}}×{{h}}mm)',
        passport: 'Passport ({{w}}×{{h}}mm)',
        visa: 'Visa ({{w}}×{{h}}mm)',
        driver: 'Driver license ({{w}}×{{h}}mm)',
      },
      errors: {
        UNKNOWN_SIZE: 'Unknown size',
        INVALID_DPI: 'DPI must be 30–1200',
    ...
    'image-grid-cut': {
      ...
      rows: 'Rows',
      gap: 'Gap (px)',
      dropHint: 'Drop an image to slice',
      downloadTile: 'Download row {{row}}, column {{col}}',
      errors: {
        EMPTY: 'Invalid image size',
        TOO_MANY: 'Too many rows/columns; tiles would be < 1px',
        LOAD: 'Failed to load image',
      },
    },
    'image-ascii': {
      ...
      width: 'Width (cols)',
      invert: 'Invert',
      dropHint: 'Drop an image to convert',
      output: 'ASCII art',
      errors: {
        EMPTY: 'Invalid image size',
        INVALID: 'Invalid pixel data',
        LOAD: 'Failed to load image',
      },
    },
    'timezone-converter': {
      ...
      errors: {
        ...
        INVALID_ZONE: 'Invalid time zone',
      },
    },
    'tax-loan-calculator': {
      mode: 'Mode',
      ...
      errors: {
        INVALID_PRINCIPAL: 'Principal must be > 0',
        INVALID_MONTHS: 'Months must be 1–1200',
        INVALID_RATE: 'Rate cannot be negative',
        INVALID_GROSS: 'Income cannot be negative',
        INVALID_DEDUCTION: 'Deductions cannot be negative',
      },
    },
    'unit-converter': {
      category: 'Category',
    ...
    'bulk-rename': {
      ...
      dropHint: 'Drop files to fill the name list',
      names: 'File names (one per line)',
      namesPlaceholder: 'One file name per line',
      output: 'Rename preview',
      duplicateWarning: '⚠️ Duplicate names: {{names}}',
      errors: {
        EMPTY: 'Enter at least one file name',
    ...
    'file-split-merge': {
      ...
      splitHint: 'Drop the file to split',
      mergeHint: 'Drop the parts to merge (sorted by name)',
      partsCount: '{{count}} parts generated',
      mergedSize: 'Merged size {{size}} bytes',
      mergeTip: 'Download all parts; merging sorts them by name to restore the file.',
      mergeOrder: 'Merging {{count}} parts in name order',
      errors: {
        EMPTY: 'Content is empty',
        INVALID_SIZE: 'Part size must be > 0',
        INVALID_COUNT: 'Parts must be ≥ 2',
      },
    },
    'zip-manager': {
      mode: 'Mode',
      ...
      createHint: 'Drop or select multiple files to pack',
      extractHint: 'Drop a .zip file to inspect',
      downloadZip: 'Download ZIP',
      errors: {
        NO_FILES: 'Select at least one file',
        CREATE_FAILED: 'Failed to create archive',
    ...
    barcode: {
      ...
      errors: {
        ...
        INVALID_CHARS: 'Contains unsupported characters',
        INVALID_CHECKSUM: 'Invalid EAN-13 check digit',
      },
    },
    'id-generator': {
      type: 'Type',
      ...
      output: 'Result',
      errors: {
        INVALID_COUNT: 'Count must be 1–1000',
      },
    },
    'code-minify': {
      language: 'Language',
      ...
      working: 'Working…',
      conservativeHint:
        'JS / HTML use conservative minification (comments and extra whitespace only) for safety.',
      input: 'Source',
      output: 'Minified',
      ...
      errors: {
        ...
        MINIFY_FAILED: 'Minify failed, check the code',
      },
    },
    'csv-tool': {
      direction: 'Direction',
      ...
      convert: 'Convert',
      inputPlaceholder: 'Paste CSV or JSON',
      errors: {
        EMPTY: 'Please enter content',
        INVALID_JSON: 'Invalid JSON',
        NOT_ARRAY: 'JSON must be an array',
      },
    },
    'key-converter': {
      target: 'Target format',
      input: 'Key input',
      inputPlaceholder: 'Paste a PEM / DER / JWK / ssh-rsa key',
      convert: 'Convert',
      output: 'Result',
      errors: {
        EMPTY: 'Please enter a key',
        INVALID_INPUT: 'Cannot parse this key',
        INVALID_KEY: 'Key cannot be imported',
        UNSUPPORTED: 'Unsupported key type',
        NEED_PUBLIC: 'OpenSSH only supports public keys',
      },
    },
    'rsa-crypto': {
      mode: 'Action',
      ...
      signaturePlaceholder: 'Paste the signature to verify',
      output: 'Output',
      run: 'Run',
      verified: '✅ Signature valid',
      notVerified: '⚠️ Signature invalid',
      errors: {
        GENERATE_FAILED: 'Key generation failed',
        INVALID_KEY: 'Unrecognized key format',
        EMPTY: 'Input cannot be empty',
        INVALID_INPUT: 'Invalid input format',
        ENCRYPT_FAILED: 'Encryption failed',
        DECRYPT_FAILED: 'Decryption failed (bad key or ciphertext)',
    ...
    'password-hash': {
      ...
      salt: 'Salt (Hex)',
      saltPlaceholder: 'Empty = random 16 bytes',
      ...
      errors: {
        ...
        INVALID_ITERS: 'Iterations must be 1–10000000',
        INVALID_SALT: 'Salt must be hex of ≥ 8 bytes',
        DERIVE_FAILED: 'Derivation failed, try again',
      },
    },
    'password-strength': {
      input: 'Password',
      ...
      checks: {
        ...
        digit: 'Digits',
        symbol: 'Symbols',
        length12: 'Length {{length}} (≥ 12 recommended)',
      },
      issues: {
        too_short: 'Too short, use at least 8 characters',
        no_lower: 'Missing lowercase letters',
        no_upper: 'Missing uppercase letters',
        no_digit: 'Missing digits',
        no_symbol: 'Missing symbols',
        sequential: 'Contains sequences like 123 or abc',
        repeated: 'Contains repeats like aaa',
        common: 'Matches a common weak password',
      },
    },
    checksum: {
      algorithm: 'Algorithm',
      source: 'Source',
      textInput: 'Text',
      textPlaceholder: 'Enter text to checksum',
      fileHint: 'Drop a file to compute its checksum',
      result: '{{algorithm}} result',
      computing: 'Computing…',
    },
    'encoding-rescue': {
      input: 'Garbled input',
      placeholder: "Paste the broken text, e.g. 'ä¸­æ–‡'",
      errors: {
        EMPTY: 'Please enter something',
        NO_CANDIDATE: 'No recoverable encoding found',
      },
    },
    'escape-unescape': {
      modes: {
    ...
    'caesar-cipher': {
      ...
      rails: 'Rails',
      input: 'Input',
      placeholder: 'Enter text or cipher',
      output: 'Output',
      errors: {
        RAILS_TOO_SMALL: 'Rails must be ≥ 2',
      },
    },
    'morse-code': {
      modes: {
      ...
      output: 'Output',
      errors: {
        INVALID: 'Unrecognized Morse symbol',
      },
    },
    'base-encoding': {
      modes: {
      ...
      errors: {
        EMPTY: 'Please enter something',
        INVALID: 'Input is not valid encoding',
      },
    },
    'pdf-compress': {
      ...
      level: 'Method',
      levels: {
        objects: 'Object streams (lossless)',
        raster: 'Per-page JPEG (lossy)',
      },
      quality: 'JPEG quality',
      scale: 'Render scale',
      rasterHint:
        'Lossy mode drops the text layer and re-draws each page as an image: smaller but not selectable.',
      run: 'Compress & download',
      result: '{{lossy}} compressed by {{percent}}% (~{{bytes}} bytes)',
      lossy: 'Lossy',
      lossless: 'Lossless',
      errors: {
        NOT_PDF: 'Only PDF files are supported',
        TOO_LARGE: 'File is too large',
        NEED_PASSWORD: 'This file is encrypted, please enter a password',
        WRONG_PASSWORD: 'Wrong password',
        LOAD_FAILED: 'Failed to parse the PDF',
        NO_PAGES: 'The PDF has no pages',
        PROCESS_FAILED: 'Processing failed, please retry',
      },
    },
    'pdf-watermark': {
      password: 'Password (optional)',
      ...
      pageSelection: 'Page range (e.g. 1-3,5)',
      tiled: 'Tile',
      spacing: 'Tile spacing',
      run: 'Add watermark & download',
      errors: {
        NOT_PDF: 'Only PDF files are supported',
        TOO_LARGE: 'File is too large',
        EMPTY_TEXT: 'Please enter watermark text',
        ...
        NO_PAGES: 'The PDF has no pages',
        PROCESS_FAILED: 'Processing failed, please retry',
        EMPTY: 'Please enter page range',
        INVALID_RANGE: 'Invalid page range',
      },
    },
    'pdf-decrypt': {
      hint: 'Upload a password-protected PDF, enter the open password and export an unprotected copy.',
      password: 'Open password',
      passwordHint: 'Enter the user password of this PDF',
      run: 'Remove password & download',
      errors: {
        NOT_PDF: 'Only PDF files are supported',
        TOO_LARGE: 'File is too large',
        NEED_PASSWORD: 'This file is encrypted, please enter a password',
    ...
    'pdf-extract-text': {
      hint: 'Upload a PDF to extract text from all pages; copy or download as .txt.',
      password: 'Password (optional)',
      passwordHint: 'Encrypted files need the open password',
      run: 'Extract text',
      pages: '{{count}} pages',
      errors: {
        NOT_PDF: 'Only PDF files are supported',
    ...
    'random-port': {
      ...
      range: 'Range',
      unique: 'Unique',
      excludeSystem: 'Avoid common ports',
      generate: 'Generate',
      ports: 'Ports',
      err: {
        INVALID_COUNT: 'Count must be 1–500',
        INVALID_RANGE: 'Invalid range (1–65535)',
        RANGE_TOO_SMALL: 'Range too small to dedupe',
      },
    },
    'websocket-tester': {
      url: 'Server URL',
      ...
      err: {
        EMPTY: 'Please enter a WebSocket URL',
        INVALID_URL: 'Invalid URL',
        INVALID_SCHEME: 'Only ws / wss allowed',
      },
    },
    'http-request': {
      method: 'Method',
      ...
      body: 'Body',
      send: 'Send',
      fromCurl: 'Import from curl',
      duration: 'Duration',
      size: 'Size',
      copyCurl: 'Copy as curl',
      err: {
        protocol: 'Enter a URL starting with http(s)://',
        EMPTY: 'Please enter a curl command',
        NOT_CURL: 'Not a valid curl command',
        NO_URL: 'curl command has no URL',
      },
    },
    'http-headers': {
      options: 'Options',
    ...
    'mac-address': {
      ...
      generateTitle: 'Bulk generate',
      count: 'Count',
      separator: 'Separator',
      caseLabel: 'Uppercase',
      generate: 'Generate',
      err: {
        EMPTY: 'Please enter a MAC',
        INVALID: 'Invalid MAC format',
        INVALID_COUNT: 'Count must be 1–200',
      },
    },
    'ip-calc': {
      input: 'Input',
      placeholder: '192.168.1.100/24 or 2001:db8::1/64',
      fields: {
        network: 'Network',
      ...
      splitTitle: 'Subnet split (VLSM / equal)',
      splitPlaceholder: 'Target prefix, e.g. 26',
      err: {
        EMPTY: 'Please enter an IP',
        INVALID_PREFIX: 'Invalid prefix',
        INVALID_ADDRESS: 'Invalid address',
        INVALID_SPLIT_PREFIX: 'Target prefix must be larger than the original',
        TOO_MANY_SUBNETS: 'Too many subnets (max {{max}})',
      },
    },
    base64: {
      direction: {
    ...
    doodle: {
      ...
      export: 'Export',
      fgColor: 'Foreground (stroke)',
      bgColor: 'Background (fill)',
      swapColors: 'Swap colors',
      moreColors: 'More colors',
      recentColors: 'Recent',
      colorHint: 'Left-click sets the foreground (stroke); right-click sets the background (fill)',
      zoom: 'Zoom',
      zoomIn: 'Zoom in',
      zoomOut: 'Zoom out',
      zoomFit: 'Fit',
      polygonHint:
        'Click to add points; click the first point or press Enter to close; Backspace removes the last point; Esc cancels',
      moveHint: 'Drag to move the whole drawing',
      pickerHint: 'Click the canvas to pick a color',
      size: 'Size',
      opacity: 'Opacity',
      pressure: 'Pressure',
      fill: 'Fill',
      ...
      bg: { transparent: 'Transparent', solid: 'Solid', grid: 'Grid' },
      canvasSize: 'Canvas',
      sizeFit: 'Fit',
      sizeCustom: 'Custom',
      width: 'Width',
      ...
      exportPngTransparent: 'Transparent PNG',
      exportJpg: 'Export JPG',
      undo: 'Undo',
      redo: 'Redo',
      hint: 'Drag on the canvas to draw; mouse, touch and pen pressure supported; right-click a swatch to set the background color',
      hintKeys:
        'Ctrl/⌘+Z undo, Ctrl/⌘+Shift+Z redo, 1~9 switch tools, I eyedropper / V move, Enter closes a polygon',
