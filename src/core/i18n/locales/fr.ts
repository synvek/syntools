...
const fr = {
  ...
  tools: {
    ...
    doodle: {
      details: 'Plus de réglages',
      collapse: 'Réduire la barre',
      expand: 'Développer la barre',
      export: 'Exporter',
      fgColor: 'Premier plan (trait)',
      bgColor: 'Arrière-plan (remplissage)',
      swapColors: 'Échanger les couleurs',
      moreColors: 'Plus de couleurs',
      recentColors: 'Récentes',
      colorHint: 'Clic gauche : premier plan (trait) ; clic droit : arrière-plan (remplissage)',
      zoom: 'Zoom',
      zoomIn: 'Zoom avant',
      zoomOut: 'Zoom arrière',
      zoomFit: 'Ajuster',
      polygonHint:
        'Cliquez pour ajouter des points ; cliquez sur le premier point ou appuyez sur Entrée pour fermer ; Retour arrière supprime le dernier point ; Échap annule',
      moveHint: 'Glissez pour déplacer tout le dessin',
      pickerHint: 'Cliquez sur le canevas pour prélever une couleur',
      size: 'Taille',
      opacity: 'Opacité',
      pressure: 'Pression',
      fill: 'Remplissage',
      textSize: 'Corps du texte',
      color: 'Couleur',
      customColor: 'Couleur personnalisée',
      background: 'Fond du canevas',
      bg: { transparent: 'Transparent', solid: 'Uni', grid: 'Grille' },
      canvasSize: 'Toile',
      sizeFit: 'Ajuster',
      ...
      undo: 'Annuler',
      redo: 'Rétablir',
      hint: 'Glissez sur le canevas pour dessiner ; souris, tactile et pression du stylet pris en charge ; clic droit sur une pastille pour définir l’arrière-plan',
      hintKeys:
        'Ctrl/⌘+Z annuler, Ctrl/⌘+Shift+Z rétablir, 1~9 changer d’outil, I pipette / V déplacer, Entrée ferme le polygone',
