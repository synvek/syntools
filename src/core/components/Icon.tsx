...
const icons: Record<string, ReactNode> = {
  ...
  github: (
    <path
      fill="currentColor"
      stroke="none"
      d="M12 2C6.477 2 2 6.584 2 12.217c0 4.513 2.865 8.337 6.839 9.687.5.092.682-.222.682-.494 0-.243-.009-.887-.014-1.741-2.782.616-3.369-1.37-3.369-1.37-.454-1.181-1.11-1.495-1.11-1.495-.908-.635.069-.622.069-.622 1.003.072 1.531 1.053 1.531 1.053.892 1.559 2.341 1.109 2.91.848.092-.66.35-1.11.636-1.365-2.22-.258-4.555-1.135-4.555-5.052 0-1.116.39-2.028 1.029-2.743-.103-.258-.446-1.297.098-2.703 0 0 .84-.274 2.75 1.046A9.36 9.36 0 0 1 12 6.844c.85.004 1.705.117 2.504.343 1.909-1.32 2.747-1.046 2.747-1.046.546 1.406.203 2.445.1 2.703.64.715 1.028 1.627 1.028 2.743 0 3.927-2.339 4.791-4.566 5.044.359.316.679.942.679 1.899 0 1.37-.012 2.475-.012 2.812 0 .274.18.591.688.492C19.138 20.55 22 16.728 22 12.217 22 6.584 17.523 2 12 2Z"
    />
  ),
  dice: (
    <>
